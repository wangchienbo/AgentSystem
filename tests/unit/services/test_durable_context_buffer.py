...
def test_context_center_exposes_session_aware_pending_buffer(tmp_path) -> None:
    ...
    center.append_pending_buffer_event("sess-a", {"timestamp": "2099-05-04T17:08:00Z", "role": "user", "message": "a1"})
    center.append_pending_buffer_event("sess-b", {"timestamp": "2099-05-04T17:08:10Z", "role": "user", "message": "b1"})
    center.append_pending_buffer_event("sess-a", {"timestamp": "2099-05-04T17:08:20Z", "role": "system", "message": "a2"})
