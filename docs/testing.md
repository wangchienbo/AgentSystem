...
- generated-app shape coverage now verifies text-style single-skill apps and multi-step pipelines emit different role names, task metadata, and action/view labels instead of sharing identical generic wording
