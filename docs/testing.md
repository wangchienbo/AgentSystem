...
- workflow diagnostics API for summarizing latest execution/failure/retry state per app/workflow, including failed-step filtering and latest-recovery summaries
