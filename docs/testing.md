...
- structured app-creation result coverage, ensuring blueprint/install closure state is asserted through `AppCreationResult` fields instead of only through human-readable success messages
