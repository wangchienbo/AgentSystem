...
- new management-presenter coverage for row-based package/app list rendering, validating installed-package lists, package-search status rows, and app status icon rows independently of the gateway shell
