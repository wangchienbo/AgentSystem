...
- asset-detail document coverage for shared interface-detail rendering, including list-to-dict normalization and schema block output, so query_asset_detail rendering can move out of gateway logic without losing interface documentation fidelity
