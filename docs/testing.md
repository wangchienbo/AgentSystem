...
- phase-closure validation coverage centered on the shared runtime-asset formatter suite plus focused smoke checks, because full bootstrap-wide gateway suites are materially slower and exceed the marginal value needed for this presentation-layer refactor phase
