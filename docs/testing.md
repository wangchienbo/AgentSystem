...
- executable workflow-action coverage for solution review, task-list, repo-context, implementation, and acceptance action slices, including bounded live `/api/action` chain checks
