...
- management phase-closure coverage, including availability-guard rendering and a focused smoke pass confirming the shared presenter layer remains sufficient after the closure audit fixes
