...
- formatter coverage for self-iteration list/detail replies, including operator-priority ordering for asset summaries and asset-specific detail rendering, so gateway rendering can be refactored without losing behavior
