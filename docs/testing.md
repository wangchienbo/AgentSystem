...
- dedicated design-blueprint-builder coverage, validating deterministic AppDesignResult -> AppBlueprint materialization and the orchestrator confirm-step handoff that consumes this builder
