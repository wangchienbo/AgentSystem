...
- executable workflow-action coverage for solution review, task-list, repo-context, implementation, and acceptance action slices, including bounded live `/api/action` chain checks for richer repo-truth, implementation validation-map, and normalized acceptance-evidence payloads
