...
- package detail presenter coverage for metadata + build-history rendering, validating `package_show` style output independently of gateway execution/bootstrap cost
