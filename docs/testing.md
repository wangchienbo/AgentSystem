...
- asset-overview prompt coverage for both interface-backed catalog entries and function-backed asset registry entries, ensuring shared overview rendering preserves compatibility across the two asset catalog models
