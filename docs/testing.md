...
- interpreter/gateway draft-continuation coverage should validate not only staged `继续` advancement and lifecycle handoff payloads, but also executable `apply_draft_app` action routing into the application layer and lifecycle registration
