...
- real registry/install integration coverage for app generation, asserting the confirm step can materialize a blueprint, register it into `AppRegistryService`, and successfully install through `AppInstallerService` instead of only through mocked install collaborators
