...
- shared strategy-formatter coverage ensuring self-iteration strategy text shaping can be validated independently of the gateway transport path, so rendering logic stays modular and testable
