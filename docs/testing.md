...
- focused app-generation acceptance-slice coverage, exercising confirmation + real design-blueprint materialization + install handoff + structured result assertions in one fast test path
