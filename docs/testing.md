...
- app-design orchestrator closure coverage ensuring the confirmation step can advance beyond skill creation into optional blueprint materialization and install handoff when those collaborators are present
