...
- asset-info summary coverage for shared capability extraction and info rendering helpers, ensuring query-asset info paths can refactor away local method-list assembly without changing operator-visible output
