...
- app-creation closure results should expose blueprint/install progress as structured data rather than only embedding it in success prose, so upper layers can compose on real state instead of scraping message text
