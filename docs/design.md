...
- the final high-frequency management presentation boundary is status messaging: operation-specific failure copy plus the short uninstall success reply can share one small presenter without over-generalizing unrelated domains
