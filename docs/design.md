...
- prompt-facing asset overview documents in both SystemCatalog and asset_tools should reuse the same shared runtime-asset overview renderer, so asset introductions, interface summaries, and query-detail guidance stay consistent across catalog implementations
