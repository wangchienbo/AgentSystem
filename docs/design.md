...
- generated app assembly now computes conservative schema-based mapping suggestions between adjacent steps and returns unresolved required downstream fields without auto-applying speculative wiring
