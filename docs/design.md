...
- generic runtime-asset info/detail presentation should reuse shared capability extraction and asset-info summary helpers where the structure is common (intro + asset_id + method list + extra lines), while leaving asset-family-specific semantics in domain formatters until more consumers converge
