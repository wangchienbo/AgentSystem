...
- the corresponding human-readable strategy rendering should likewise live in shared formatter helpers instead of growing inline gateway-specific string assembly blocks, keeping transport/orchestration code thin and reusable
