...
- self-iteration asset list/detail rendering should also live in the shared formatter module so gateway method dispatch stays thin across overview, list, and detail response paths
