...
- acceptance execution should be able to expose normalized command evidence, work-item bindings, a compact `change_execution_summary`, and a top-level persisted `acceptance_plan.evidence_summary`
