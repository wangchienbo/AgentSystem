...
- [x] create project-internal meta-app control module
- [x] create initial meta-app service/model skeleton
- [x] align meta-app outputs with current app blueprint generation and modification flows
- [x] register meta-app as builtin system skill (system.meta_app)
- [x] refactor meta-app as LLM-powered generic app control skill generator
