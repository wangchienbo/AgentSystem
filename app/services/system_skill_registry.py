...
SYSTEM_SKILL_SPECS: dict[str, dict] = {
    ...
    "requirement.skill": {
        "name": "Requirement Capability Skill",
        "immutable_interface": True,
        "version": "1.0.0",
        "content": "requirement capability handler",
        "capability_profile": SkillCapabilityProfile(
            intelligence_level="L1_assisted",
            network_requirement="N0_none",
            runtime_criticality="C2_required_runtime",
        ...
        "manifest": authoring.build_callable_entry(
            ...
            name="Requirement Capability Skill",
            handler_entry="app.bootstrap.skills:requirement_capability_skill",
            description="Requirement clarify/extract/readiness/blueprint draft surface",
            input_schema_ref="schema://requirement.skill/input",
            output_schema_ref="schema://requirement.skill/output",
            error_schema_ref="schema://requirement.skill/error",
            tags=["system", "requirement", "capability"],
            immutable_interface=True,
            capability_profile=SkillCapabilityProfile(
                intelligence_level="L1_assisted",
                network_requirement="N0_none",
    ...
    "evidence.skill": {
        "name": "Evidence Capability Skill",
        "immutable_interface": True,
        "version": "1.0.0",
        "content": "evidence capability handler",
        "capability_profile": SkillCapabilityProfile(
            intelligence_level="L1_assisted",
            network_requirement="N0_none",
            runtime_criticality="C2_required_runtime",
        ...
        "manifest": authoring.build_callable_entry(
            ...
            name="Evidence Capability Skill",
            handler_entry="app.bootstrap.skills:evidence_capability_skill",
            description="Evidence list/stats/context summary surface",
            input_schema_ref="schema://evidence.skill/input",
            output_schema_ref="schema://evidence.skill/output",
            error_schema_ref="schema://evidence.skill/error",
            tags=["system", "evidence", "retrieval"],
            immutable_interface=True,
            capability_profile=SkillCapabilityProfile(
                intelligence_level="L1_assisted",
                network_requirement="N0_none",
    ...
    "context.compaction.skill": {
        "name": "Context Compaction Capability Skill",
        "immutable_interface": True,
        "version": "1.0.0",
        "content": "context compaction capability handler",
        "capability_profile": SkillCapabilityProfile(
            intelligence_level="L1_assisted",
            network_requirement="N0_none",
            runtime_criticality="C2_required_runtime",
        ...
        "manifest": authoring.build_callable_entry(
            skill_id="context.compaction.skill",
            name="Context Compaction Capability Skill",
            handler_entry="app.bootstrap.skills:context_compaction_capability_skill",
            description="Context compact/working-set/layer surface",
            input_schema_ref="schema://context.compaction.skill/input",
            output_schema_ref="schema://context.compaction.skill/output",
            error_schema_ref="schema://context.compaction.skill/error",
            tags=["system", "context", "compaction"],
            immutable_interface=True,
            capability_profile=SkillCapabilityProfile(
                intelligence_level="L1_assisted",
                network_requirement="N0_none",
