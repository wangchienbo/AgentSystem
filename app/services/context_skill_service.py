        ...
        if request.operation == "list_runtime_view":
            ...
            context_payload = {
                ...
                "entries": [
                    ...
                    for entry in context_obj.entries
                ],
            }
            ...
            if runtime_obj is not None:
                runtime_payload = {
                    ...
                    "lease": None if runtime_obj.lease is None else {
                        "app_instance_id": runtime_obj.lease.app_instance_id,
                        "status": runtime_obj.lease.status,
                        "health": runtime_obj.lease.health,
                        "last_heartbeat_at": runtime_obj.lease.last_heartbeat_at.isoformat(),
                        "restart_count": runtime_obj.lease.restart_count,
                    },
                    "latest_checkpoint": None if runtime_obj.latest_checkpoint is None else {
                        "checkpoint_id": runtime_obj.latest_checkpoint.checkpoint_id,
                        "app_instance_id": runtime_obj.latest_checkpoint.app_instance_id,
                        "status": runtime_obj.latest_checkpoint.status,
                        "pending_tasks": list(runtime_obj.latest_checkpoint.pending_tasks),
                        "metadata": dict(runtime_obj.latest_checkpoint.metadata),
                        "created_at": runtime_obj.latest_checkpoint.created_at.isoformat(),
                    },
                }
            return {
