...
SCAN_PROFILES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "regex": r"(router|route|endpoint|api_router|apirouter|@app\.|@router\.|path\()",
        "scan_roots": ["app/system", "app/api", "app/interactive_app.py", "app/interactive_app_workflow.py"],
        "file_extensions": [".py"],
        "max_files": 120,
    ...
    },
    {
        ...
        "scan_roots": ["app", "config", "scripts"],
        "file_extensions": [".py", ".yaml", ".yml", ".toml", ".ini", ".json"],
        "max_files": 160,
        "max_hits_per_file": 10,
        "max_rows": 20,
    ...
    },
    {
        ...
        "scan_roots": ["app/models", "app/skills", "app"],
        "file_extensions": [".py"],
        "max_files": 140,
        "max_hits_per_file": 12,
        "max_rows": 20,
    ...
    },
    {
        ...
        "scan_roots": ["app/services", "app/system/runtime", "app/bootstrap", "app"],
        "file_extensions": [".py"],
        "max_files": 150,
        "max_hits_per_file": 12,
        "max_rows": 20,
    ...
    },
    {
        ...
        "regex": r"(validate_|validator|require_valid|constraint|risk|error|invalid|required_[a-z_]+)",
        "scan_roots": ["app/services", "app/skills", "app/models", "app"],
        "file_extensions": [".py"],
        "max_files": 140,
        "max_hits_per_file": 10,
        "max_rows": 20,
    ...
    },
    {
        ...
        "scan_roots": ["app/services", "app/governance", "app/system/gateway", "app/ai", "app/skills"],
        "file_extensions": [".py"],
        "max_files": 120,
        "max_hits_per_file": 10,
        "max_rows": 20,
    ...
    },
    {
        ...
        "regex": r"(FastAPI|APIRouter|@app\.|@router\.|Request|Response|HTTPException|endpoint)",
        "scan_roots": ["app/api", "app/system/gateway", "app/interactive_app.py", "app/interactive_app_workflow.py", "app/skills"],
        "file_extensions": [".py"],
        "max_files": 120,
        "max_hits_per_file": 10,
        "max_rows": 20,
    ...
    },
    {
        ...
        "scan_roots": ["app/persistence", "app/services", "app/interactive_app.py", "app/interactive_app_workflow.py", "app"],
