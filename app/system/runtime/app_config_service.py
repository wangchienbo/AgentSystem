...
class AppConfigService:
    ...
    def delete_app_config(self, app_instance_id: str) -> bool:
        removed = False
        if app_instance_id in self._snapshots:
            del self._snapshots[app_instance_id]
            removed = True
        if app_instance_id in self._history:
            del self._history[app_instance_id]
            removed = True
